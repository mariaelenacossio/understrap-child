  ...
  <div class="container overflow-hidden">
    <div class="row gy-5">
      ...
      <div class="col-12">
        ...
        <section class="blog-cards-2">
  <ul class='slider'>
    <li class='card-item' style="background-image: url('https://images.unsplash.com/photo-1598624211345-d321dda059b2?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTV8fGNhcnMlMjB3YWxscGFwZXJzfGVufDB8MHwwfHx8MA%3D%3D')">
      <div class='content'>
    ...
    <li class='card-item' style="background-image: url('https://images.unsplash.com/photo-1621718229986-ded7d999e908?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTIzfHxjYXJzJTIwd2FsbHBhcGVyc3xlbnwwfDB8MHx8fDA%3D')">
      <div class='content'>
        <h2 class='title'>"Lorem Ipsum"</h2>
        <p class='description'> Lorem ipsum, dolor sit amet consectetur
        adipisicing elit. Tempore fuga voluptatum, iure corporis inventore
    ...
    <li class='card-item' style="background-image: url('https://images.unsplash.com/photo-1538690931238-dcc3b4263c2e?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NDZ8fGNhcnMlMjB3YWxscGFwZXJzfGVufDB8MHwwfHx8MA%3D%3D')">
      <div class='content'>
        <h2 class='title'>"Lorem Ipsum"</h2>
        <p class='description'> Lorem ipsum, dolor sit amet consectetur
        adipisicing elit. Tempore fuga voluptatum, iure corporis inventore
    ...
    <li class='card-item' style="background-image: url('https://images.unsplash.com/photo-1570506020466-17c74d2f4590?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTE4fHxjYXJzJTIwd2FsbHBhcGVyc3xlbnwwfDB8MHx8fDA%3D')">
      <div class='content'>
        <h2 class='title'>"Lorem Ipsum"</h2>
        <p class='description'>
    ...
    <li class='card-item' style="background-image: url('https://images.unsplash.com/photo-1535382651921-5e77ea4458f2?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjJ8fGNhcnMlMjB3YWxscGFwZXJzfGVufDB8MHwwfHx8MA%3D%3D')">
      <div class='content'>
        <h2 class='title'>"Lorem Ipsum"</h2>
        <p class='description'>
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Tempore fuga voluptatum, iure corporis inventore praesentium nisi. Id laboriosam ipsam enim.
    ...
    <li class='card-item' style="background-image: url('https://images.unsplash.com/photo-1631419162960-d90d86d481ea?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')">
      <div class='content'>
        <h2 class='title'>"Lorem Ipsum"</h2>
        <p class='description'> Lorem ipsum, dolor sit amet consectetur
        adipisicing elit. Tempore fuga voluptatum, iure corporis inventore
