                    ...
                    <article class="post">
                      <div class="post-content mb-5">
                        ...
                        <div class="row g-6 mt-3 mb-10">
                          <div class="col-md-6">
                            <figure class="hover-scale rounded cursor-dark"><a href="http://mariaelena-cossioclark.com/wp-content/uploads/2023/11/blog-post-1-gal-1.jpg" data-glightbox="title: Heading; description: Purus Vulputate Sem Tellus Quam" data-gallery="post"> <img src="./assets/img/photos/b8.jpg" alt="" /></a></figure>
                          </div>
                          <!--/column -->
                          <div class="col-md-6">
                          ...
                          <!--/column -->
                          <div class="col-md-6">
                            <figure class="hover-scale rounded cursor-dark"><a href="http://mariaelena-cossioclark.com/wp-content/uploads/2023/11/blog-post-1-gal-3.jpg" data-glightbox data-gallery="post"> <img src="./assets/img/photos/b10.jpg" alt="" /></a></figure>
                          </div>
                          <!--/column -->
                          <div class="col-md-6">
                            <figure class="hover-scale rounded cursor-dark"><a href="http://mariaelena-cossioclark.com/wp-content/uploads/2023/11/blog-post-1-gal-4.jpg" data-glightbox data-gallery="post"> <img src="./assets/img/photos/b11.jpg" alt="" /></a></figure>
                          </div>
                          <!--/column -->
                        </div>
                        <!-- /.row -->
