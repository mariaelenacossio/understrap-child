	...
	<div class="d-flex flex-column flex-shrink-0 align-items-center" style="width: 4rem;">
		...
		<!-- </a> --> <!--Logo icon, add ASAP-->
			...
			<ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
				...
				<a href="https://mariaelena-cossioclark.com/#about" class="nav-link py-3 border-bottom" title="About" data-bs-toggle="tooltip" data-bs-placement="right">
				...
				<li class="nav-item icon-fill">
				<a href="https://mariaelena-cossioclark.com/#contact" class="nav-link py-3 border-bottom" title="Contact" data-bs-toggle="tooltip" data-bs-placement="right">
