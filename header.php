		...
		<!-- </a> --> <!--Logo icon, add ASAP-->
			...
			<ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
				...
				<a href="#about" class="nav-link py-3 border-bottom" title="About" data-bs-toggle="tooltip" data-bs-placement="right">
					<!-- Link to the home page with a fragment identifier to scroll to the "About" section -->
					<a href="https://mariaelena-cossioclark.com/#about" title="Return to About Section">Return to About Section</a>
