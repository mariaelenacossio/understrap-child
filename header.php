...
<div class="site" id="page">
	...
	<div class="d-flex flex-column flex-shrink-0 align-items-center" style="width: 4rem; 60vh;">
			<ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
				...
				<li class="nav-item">
				<a href="https://mariaelena-cossioclark.com/#about" class="nav-link py-3" title="About" data-bs-toggle="tooltip" data-bs-placement="right">
				...
				<li class="nav-item">
				<a href="https://mariaelena-cossioclark.com/#portfolio" class="nav-link py-3" title="Portfolio" data-bs-toggle="tooltip" data-bs-placement="right">
				...
				<li class="nav-item">
				<a href="https://mariaelena-cossioclark.com/#contact" class="nav-link py-3" title="Contact" data-bs-toggle="tooltip" data-bs-placement="right">
				...
				<li class="nav-item">
				<a href="https://github.com/mariaelenacossio" class="nav-link py-3" title="Github" data-bs-toggle="tooltip" data-bs-placement="right" target="_blank">
				...
				<li class="nav-item">
				<a href="https://www.linkedin.com/in/mariaelena-cossio-clark-320ba416b/" class="nav-link py-3" title="Linkedin" data-bs-toggle="tooltip" data-bs-placement="right" target="_blank">
